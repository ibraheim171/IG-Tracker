...
export default async function HomePage() {
  ...
  const [slotsResult, waitingResult, itemsResult, adminUsersResult] = await Promise.all([
  ...
  return <SlotsBoard slots={slots} items={items} currentUserId={profile.id} roles={profile.roles} teamMembers={teamMembers} teamMembersLoadError={adminUsersResult.error} loadError={loadError} />;
}
